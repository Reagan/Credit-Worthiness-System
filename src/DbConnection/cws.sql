...
CREATE TABLE `credit` (
  ...
  KEY `fk_credit_customers` (`customers_id`),
  CONSTRAINT `fk_credit_customers` FOREIGN KEY (`customers_id`) REFERENCES `customers` (`customers_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2011-12-15  6:38:24
