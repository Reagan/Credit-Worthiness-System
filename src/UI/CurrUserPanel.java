...
import UI.Listeners.EditCurrUserListener;
 ...
 */
public class CurrUserPanel extends JPanel
{
    ...
    private EditCurrUserListener newUserListener ;
    ...
    public CurrUserPanel(JDialog dialog)
    {
        ...
        userPicListener = new UserPictureListener(CurrUserPanel.this, pictureArea) ;
        ...
        newUserListener = new EditCurrUserListener(CurrUserPanel.this) ;
